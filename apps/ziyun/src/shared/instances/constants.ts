...
export const KH_HMIS_STORAGE_KEY = "kh_hmis";
export const HXZY_HMIS_STORAGE_KEY = "hxzy_hmis";
export const JTV_HMIS_STORAGE_KEY = "jtv_hmis";
...
export const FUZHOUDONG_STORAGE_KEY = "fuzhoudong";
