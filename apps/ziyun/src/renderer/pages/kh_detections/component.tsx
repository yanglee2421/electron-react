...
import { useUploadCHR52A } from "#renderer/api/kh";
...
const UploadCHR52A = (props: UploadCHR52A) => {
  ...
  return (
    ...
    >
      <PendingIcon isPending={mutation.isPending}>
        <Upload />
      </PendingIcon>
    </IconButton>
  );
          ...
          <Grid container spacing={1.5}>
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <Autocomplete
                ...
                renderInput={(props) => <TextField {...props} label="检测员" />}
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <Autocomplete
                value={zx}
                onChange={(_, value) => setZx(value || "")}
                options={["RE2B", "RD2"]}
                renderInput={(props) => <TextField {...props} label="轴型" />}
                freeSolo
                fullWidth
              />
            </Grid>
